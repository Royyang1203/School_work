...
// Please create a class Triangle who inherit class Shape from Q31

// Give class Triangle a function member

// float getPerimeter(); //return the perimeter of the triangle

// float getArea(); //return the area of the triangle
