...
// In the year 2163, wormholes were discovered. A wormhole is a subspace tunnel through space and time connecting two star systems.
// Wormholes have a few peculiar properties:

// Wormholes areone-wayonly.
...
// a specific wormhole may cause the person traveling through it to end up 15 years in the future.
...
// By traveling along this cycle a lot of times,
// the scientist is able to go back as far in time as necessary to reach the beginning of the universe and see the Big Bang with her own eyes.
// Write a program to find out whether such a cycle exists.

// Input
// The input file starts with a line containing the number of cases cc to be analyzed.
// Each case starts with a line with two number nn and mm.
// These indicate the number of star systems (1 ≤ n ≤ 1000) and the number of wormholes (0 ≤ m ≤ 2000).
// The star systems are numbered from 0 (our solar system) through n − 1.
// For each wormhole a line containing three integer numbers x, y and t is given.
// These numbers indicate that this wormhole allows someone to travel from the star system numbered x to the star system numbered y,
// thereby ending up tt (−1000 ≤ t ≤ 1000) years in the future.

// Output
// The output consists of cc lines, one line for each case,
// containing the word possiblepossible if it is indeed possible to go back in time indefinitely,
// or 'not possible' if this is not possible with the given set of star systems and wormholes.
